...
class Menu:
    ...
    def drawMenu(self):
        ...
        if   config.pos_tab_menu == 1: self.drawMenuTabInfo(*positions)
        elif config.pos_tab_menu == 2: self.drawMenuTabEnhance(*positions)
    ...
    def drawMenuTabConstellations(self, x, y, w, h):        # Tab 3
        pass
